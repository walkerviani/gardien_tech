...
) // Evita conflitos de nome entre classe EmprestimoDispositivo no database.g.dart e entidade de domínio EmprestimoDispositivo
class EmprestimoDispositivos extends Table {
  IntColumn get id => integer().autoIncrement()();
  IntColumn get idEmprestimoItem =>
      integer().references(EmprestimoItens, #id, onDelete: KeyAction.cascade)();
  IntColumn get idDispositivo => integer()
      .references(Dispositivos, #id, onDelete: KeyAction.restrict)
      .nullable()();
}
